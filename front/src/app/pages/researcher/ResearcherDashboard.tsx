...
const myStats = [
  { label: "Formulários Respondidos", value: "328", icon: ClipboardList, color: "#F5C944" },
        ...
        {myStats.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              <p style={{ fontSize: 28, fontWeight: 800, color: "#1D2E36", lineHeight: 1 }}>{s.value}</p>
          ...
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={myDaily} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
              ...
              <Bar dataKey="respostas" name="Respostas" radius={[4, 4, 0, 0]}>
                {myDaily.map((_, i) => (
                  <Cell key={i} fill={i === 3 ? "#F5C944" : "#00538C"} />
                ))}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={monthlyData} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="respostas" name="Respostas" stroke="#F5C944" strokeWidth={2} fill="url(#gradR)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
          ...
          {activeResearches.map((r, i) => (
            ...
            >
              <div
                ...
                style={{ backgroundColor: ["#F5C944", "#00538C", "#2E7D32", "#C8102E"][i % 4], color: "white" }}
              >
                {r.nome.charAt(0)}
              </div>
              <div className="flex-1">
                <p style={{ fontSize: 14, fontWeight: 700, color: "#1D2E36" }}>{r.nome}</p>
