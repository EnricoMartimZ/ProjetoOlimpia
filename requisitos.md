...
| 6 | Como servidor da Secretaria de Turismo, quero lançar uma nova edição de uma pesquisa existente, podendo modificar os campos do formulário quando necessário. | Servidor da Secretaria de Turismo | 1 | ✅ |
...
- **REQ 12 (resultados públicos):** o backend fornece os dados via API; a visualização/gráficos ficam no frontend React. Não há geração de gráficos no backend.
